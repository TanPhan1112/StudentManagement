...
/* harmony import */ var _student_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./student.js */ "./src/student.js");
/* harmony import */ var _semesterInput_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./semesterInput.js */ "./src/semesterInput.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleSemesterChange = _this.handleSemesterChange.bind(_assertThisInitialized(_this));
    _this.handleSemesterSubmit = _this.handleSemesterSubmit.bind(_assertThisInitialized(_this));
    _this.chooseSemester = _this.chooseSemester.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(App, [{
    key: "handleSemesterChange",
    value: function handleSemesterChange(event) {
      this.setState({
        currentSemester: event.target.value
      });
    }
  }, {
    key: "handleSemesterSubmit",
    value: function handleSemesterSubmit(event) {
      var _this2 = this;

      event.preventDefault();
      var newSemester = this.state.currentSemester;
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/project/v1/semesters', {
    ...
    key: "chooseSemester",
    value: function chooseSemester(semester) {
      this.setState({
        cur: semester
      });
    }
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevState.semesters.length !== this.state.semesters.length) {
        axios__WEBPACK_IMPORTED_MODULE_1___default().get("/project/v1/semesters").then(function (results) {
          var semesters = [];
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_semesterInput_js__WEBPACK_IMPORTED_MODULE_3__.default, {
        currentSemester: this.state.currentSemester,
        handleSemesterSubmit: this.handleSemesterSubmit,
        handleSemesterChange: this.handleSemesterChange
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_student_js__WEBPACK_IMPORTED_MODULE_2__.default, {
        current: this.state.cur,
        semesters: this.state.semesters,
        chooseSemester: this.chooseSemester
      }));
    }
  }]);
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _courseInput_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./courseInput.js */ "./src/courseInput.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var course = /*#__PURE__*/function (_React$Component) {
  ...
  function course(props) {
    ...
    _this.handleCurSemesterChange = _this.handleCurSemesterChange.bind(_assertThisInitialized(_this));
    _this.handleStudentIDChange = _this.handleStudentIDChange.bind(_assertThisInitialized(_this));
    _this.handleCourseNameChange = _this.handleCourseNameChange.bind(_assertThisInitialized(_this));
    _this.handleInstructorNameChange = _this.handleInstructorNameChange.bind(_assertThisInitialized(_this));
    _this.handleCourseSubmit = _this.handleCourseSubmit.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(course, [{
    key: "handleCurSemesterChange",
    value: function handleCurSemesterChange(event) {
      this.setState({
    ...
    key: "handleCourseNameChange",
    value: function handleCourseNameChange(event) {
      this.setState({
        courseName: event.target.value
      });
    }
  }, {
    key: "handleInstructorNameChange",
    value: function handleInstructorNameChange(event) {
      this.setState({
        instructorName: event.target.value
      });
    }
  }, {
    key: "handleCourseSubmit",
    value: function handleCourseSubmit(event) {
      var _this2 = this;

      event.preventDefault();
      var curSemester = this.state.curSemester;
      var stdId = this.state.studentID;
      var courseName = this.state.courseName;
      var instructorName = this.state.instructorName;
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/project/v1/courses', {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "course"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Enter courses for a student")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_courseInput_js__WEBPACK_IMPORTED_MODULE_2__.default, formProps));
    }
  }]);
...
var courseDetails = /*#__PURE__*/function (_React$Component) {
  _inherits(courseDetails, _React$Component);

  var _super = _createSuper(courseDetails);
  ...
  _createClass(courseDetails, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.props.studentList.length >= 1 && this.props.currentStudent.length !== 0) {
        if (prevProps.current !== this.props.current || prevProps.currentStudent !== this.props.currentStudent || prevState.coursesName.length !== this.state.coursesName.length || prevState.instructor.length !== this.state.instructor.length) {
          axios__WEBPACK_IMPORTED_MODULE_1___default().get("/project/v1/courses/", {
            params: {
            ...
            for (var i = 0; i < results.data.courses.length; i++) {
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "chooser"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, "Student id: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", {
        id: "stdId"
      }, this.props.currentStudent), " Semester: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", {
        id: "semester"
      }, this.props.current)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("table", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Student ID"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Firstname"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Lastname"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Program"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Courses"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "Instructor"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tbody", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, this.state.studentID), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, this.state.stdFirstName), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, this.state.stdLastName), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, this.state.stdProgram), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, this.state.coursesName.map(function (db, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
          key: index
        }, db);
      }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, this.state.instructor.map(function (db, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
          key: index
        }, db);
      }))))))));
  ...
  _createClass(courseInput, [{
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        onSubmit: this.props.handleCourseSubmit
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter a semester:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "semester",
        value: this.props.curSemester,
        onChange: this.props.handleCurSemesterChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter student ID:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "stdId",
        value: this.props.studentID,
        onChange: this.props.handleStudentIDChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter course name:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "courseName",
        value: this.props.courseName,
        onChange: this.props.handleCourseNameChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter instructor name:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "instructorName",
        value: this.props.instructorName,
        onChange: this.props.handleInstructorNameChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "submit",
        value: "Submit course information"
      })));
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (courseInput);
...
var semesterDetails = /*#__PURE__*/function (_React$Component) {
  _inherits(semesterDetails, _React$Component);

  var _super = _createSuper(semesterDetails);

  function semesterDetails() {
    _classCallCheck(this, semesterDetails);

    return _super.apply(this, arguments);
  }

  _createClass(semesterDetails, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "chooser"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, "Choose a semester"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, this.props.semesterList.map(function (db, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
          key: index
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
          onClick: function onClick() {
            return _this.props.chooseSemester(db);
          }
        }, db));
      }))));
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (semesterDetails);

/***/ }),

/***/ "./src/semesterInput.js":
/*!******************************!*\
  !*** ./src/semesterInput.js ***!
  \******************************/
/*! namespace exports */
...
var semesterInput = /*#__PURE__*/function (_React$Component) {
  _inherits(semesterInput, _React$Component);

  var _super = _createSuper(semesterInput);

  function semesterInput() {
    _classCallCheck(this, semesterInput);

    return _super.apply(this, arguments);
  }

  _createClass(semesterInput, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Student management project"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        onSubmit: this.props.handleSemesterSubmit
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Create a new semester:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "semester",
        value: this.props.currentSemester,
        onChange: this.props.handleSemesterChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "submit",
        value: "Create a semester"
      })));
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (semesterInput);
...
/* harmony import */ var _studentInput_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./studentInput.js */ "./src/studentInput.js");
/* harmony import */ var _studentDetails_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./studentDetails.js */ "./src/studentDetails.js");
/* harmony import */ var _semesterDetails_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./semesterDetails.js */ "./src/semesterDetails.js");
/* harmony import */ var _courseDetails_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./courseDetails.js */ "./src/courseDetails.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var student = /*#__PURE__*/function (_React$Component) {
  ...
  function student(props) {
    ...
    _this.handleCurSemesterChange = _this.handleCurSemesterChange.bind(_assertThisInitialized(_this));
    _this.handleStudentIDChange = _this.handleStudentIDChange.bind(_assertThisInitialized(_this));
    _this.handleStudentFirstNameChange = _this.handleStudentFirstNameChange.bind(_assertThisInitialized(_this));
    _this.handleStudentLastNameChange = _this.handleStudentLastNameChange.bind(_assertThisInitialized(_this));
    _this.handleStudentProgramChange = _this.handleStudentProgramChange.bind(_assertThisInitialized(_this));
    _this.handleStudentSubmit = _this.handleStudentSubmit.bind(_assertThisInitialized(_this));
    _this.chooseStudent = _this.chooseStudent.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(student, [{
    ...
    key: "handleStudentFirstNameChange",
    value: function handleStudentFirstNameChange(event) {
      this.setState({
        stdFirstName: event.target.value
      });
    }
  }, {
    key: "handleStudentLastNameChange",
    value: function handleStudentLastNameChange(event) {
      this.setState({
        stdLastName: event.target.value
      });
    }
  }, {
    key: "handleStudentProgramChange",
    value: function handleStudentProgramChange(event) {
      this.setState({
    ...
    key: "chooseStudent",
    value: function chooseStudent(std) {
      this.setState({
        currentStudent: std
      });
    }
  }, {
    key: "handleStudentSubmit",
    value: function handleStudentSubmit(event) {
      var _this2 = this;

      event.preventDefault();
      var curSemester = this.state.curSemester;
      var stdId = this.state.studentID;
      var firstName = this.state.stdFirstName;
      var lastName = this.state.stdLastName;
      var program = this.state.stdProgram;
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/project/v1/students', {
        semester: curSemester,
        studentID: stdId,
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.props.semesters.length >= 1) {
        if (prevProps.current !== this.props.current || prevState.students.length !== this.state.students.length) {
          axios__WEBPACK_IMPORTED_MODULE_1___default().get("/project/v1/students/".concat(this.props.current)).then(function (results) {
            if (results.data.length !== 0) {
              var students = [];

              for (var i = 0; i < results.data[0].students.length; i++) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "student"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Enter student information for a semester")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_studentInput_js__WEBPACK_IMPORTED_MODULE_3__.default, formProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_course_js__WEBPACK_IMPORTED_MODULE_2__.default, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Management details"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_semesterDetails_js__WEBPACK_IMPORTED_MODULE_5__.default, {
        semesterList: this.props.semesters,
        chooseSemester: this.props.chooseSemester
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_studentDetails_js__WEBPACK_IMPORTED_MODULE_4__.default, {
        current: this.props.current,
        studentList: this.state.students,
        chooseStudent: this.chooseStudent
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_courseDetails_js__WEBPACK_IMPORTED_MODULE_6__.default, {
...
var studentDetails = /*#__PURE__*/function (_React$Component) {
  _inherits(studentDetails, _React$Component);

  var _super = _createSuper(studentDetails);
  ...
  _createClass(studentDetails, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "chooser"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, "Choose a student id (", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", {
        id: "semester"
      }, this.props.current), ")"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, this.props.studentList.map(function (db, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
          key: index
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
          onClick: function onClick() {
            return _this.props.chooseStudent(db);
          }
        }, db));
      }))));
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (studentDetails);
...
var studentInput = /*#__PURE__*/function (_React$Component) {
  _inherits(studentInput, _React$Component);

  var _super = _createSuper(studentInput);
  ...
  _createClass(studentInput, [{
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        onSubmit: this.props.handleStudentSubmit
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter a semester:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "semester",
        value: this.props.curSemester,
        ...
        value: this.props.studentID,
        onChange: this.props.handleStudentIDChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter student first name:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "stdFirstName",
        value: this.props.stdFirstName,
        onChange: this.props.handleStudentFirstNameChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter student last name:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "stdLastName",
        value: this.props.stdLastName,
        onChange: this.props.handleStudentLastNameChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Enter student program:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "stdProgram",
        value: this.props.stdProgram,
        onChange: this.props.handleStudentProgramChange
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "submit",
        value: "Submit student information"
      })));
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (studentInput);
